# OSP Demo - Presentation API

This directory contains a demo of a Presentation API controller and receiver using the Open Screen Protocol.
...
``` bash
    $ out/debug/osp_demo [-v] [friendly_name]
```
