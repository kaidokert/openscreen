...
inline constexpr MessageType GetMessageType(uint16_t flags) {
...
inline constexpr bool IsValidFlagsSection(uint16_t flags) {
...
inline constexpr bool IsTerminationLabel(uint8_t label) {
  return label == kLabelTermination;
}

inline constexpr bool IsDirectLabel(uint8_t label) {
  return (label & kLabelTypeMask) == kLabelDirect;
}

inline constexpr bool IsPointerLabel(uint8_t label) {
  return (label & kLabelTypeMask) == kLabelPointer;
}

inline constexpr uint8_t GetDirectLabelLength(uint8_t label) {
...
inline constexpr uint16_t MakePointerLabel(uint16_t offset) {
...
inline constexpr DnsClass GetDnsClass(uint16_t rrclass) {
