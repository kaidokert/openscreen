...
class Receiver : public ReceiverBase {
 public:
  ...
  Clock::duration GetClockOffsetForTesting() const {
    return smoothed_clock_offset_.Current();
  }
 ...
 private:
  ...
  // implicitly ACKed by the checkpoint frame ID advancing. The receiver does
  // not actually do individual acks and nacks.
  // TODO: is not ACKing individual frames a feature or bug? Or just because my
  // macbook is fast?
